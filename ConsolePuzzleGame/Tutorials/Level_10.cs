...
namespace ConsolePuzzleGame.Tutorials
{
    ...
    {
        public int BoardWidth = 15, BoardHeight = 7;
        ...
        void Start()
        {
            ...
            GameLevel.PlayerXPos = 0; GameLevel.PlayerYPos = 2;
            ...
            GameLevel.ExitXPos = 10; GameLevel.ExitYPos = 6;
            ...
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 0, 5, 13, 5, BoardBuilder.FillType.SolidBox);

            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Seeker, 8, 2, "Seeker_01"));
            Game.BoardEnemies["Seeker_01"].Set(health: 2, speed: 0.3, sightRadius: 2);

            
            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 6, 2));
            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 0, 6));
            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 14, 6));

            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 14, 5, "1"));
            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 0, 5, "2"));
            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 13, 6, "3"));


            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 1, 6));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 9, 6));
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "Esse \"" : "This \"", centerLine: true));
            Header.Line[2].Add(new Text(" ", bgColor: ConsoleColor.DarkRed));
            Header.Line[2].Add(new Text("?", ConsoleColor.Red, ConsoleColor.Black));
            Header.Line[2].Add(new Text(" ", bgColor: ConsoleColor.DarkRed));
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "\" é O Perseguidor." : "\" is The Seeker."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? " Ele permanece adormecido até você chegar perto demais!" : " It stays asleep until you get too close!", centerLine: true));
            Header.Line[4].Add(new Text(MenuController.Language == 1 ? "Quando acordado, ele irá te caçar a qualquer custo!" : "When awake, it will chase you at any cost!", centerLine: true));
