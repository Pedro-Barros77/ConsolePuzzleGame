...
namespace ConsolePuzzleGame.Tutorials
{
    public class Tutorial_01 : Level
    {
        ...
        void Start()
        {
            ...
            GameLevel.ExitXPos = GameLevel.BoardWidth-1; GameLevel.ExitYPos = 0;
            ...
            GameLevel.BoardVerticalField = Console.WindowHeight - GameLevel.HeaderRows - GameLevel.FooterRows - 2;
            GameLevel.BoardHorizontalField = (Console.WindowWidth / 3) - 1;
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "Você é a letra \"" : "You are the letter \"", centerLine: true));
            Header.Line[2].Add(new Text("P", fgColor: ConsoleColor.Magenta));
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "\". Para se mover, utilize as setas do teclado ou WASD." : "\". Use arrow keys or WASD to move."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? "Seu objetivo é chegar no \"" : "Your goal is to reach \"", centerLine: true));
            Header.Line[3].Add(new Text("@", fgColor: ConsoleColor.Green));
            Header.Line[3].Add(new Text("\"."));
