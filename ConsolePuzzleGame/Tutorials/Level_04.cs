...
namespace ConsolePuzzleGame.Tutorials
{
    ...
    {
        public int BoardWidth = 5, BoardHeight = 8;
        ...
        void Start()
        {
            ...
            GameLevel.PlayerXPos = 2; GameLevel.PlayerYPos = 0;
            ...
            GameLevel.ExitXPos = 0; GameLevel.ExitYPos = 2;
            ...
            GameLevel.AddObject(new GameObject(GameController.Objects.KeyDoor, 1, 0, "a"));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 1, 1));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 1, 2));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 0, 3));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 1, 3));

            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 1, 6, 4, 6, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.KeyDoor, 0, 6, "b"));

            GameLevel.AddObject(new GameObject(GameController.Objects.Key, 3, 4, "b"));
            GameLevel.AddObject(new GameObject(GameController.Objects.Key, 4, 7, "a"));
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text("[", ConsoleColor.Black, ConsoleColor.DarkCyan));
            Header.Line[2].Add(new Text("a", ConsoleColor.Black, ConsoleColor.Cyan));
            Header.Line[2].Add(new Text("]", ConsoleColor.Black, ConsoleColor.DarkCyan));
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "\" é uma porta que só abre ao coletar uma chave específica \"" : "\" is a door that only opens after collecting a specific key \""));
            Header.Line[2].Add(new Text("a", ConsoleColor.Black, ConsoleColor.Cyan));
            Header.Line[2].Add(new Text("\"."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? "Você precisa coleta-la." : "You need to collect it.", centerLine: true));
