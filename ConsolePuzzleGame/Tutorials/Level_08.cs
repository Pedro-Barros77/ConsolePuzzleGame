...
namespace ConsolePuzzleGame.Tutorials
{
    public class Tutorial_08 : Level
    {
        ...
        void Start()
        {
            ...
            GameLevel.ExitXPos = 7; GameLevel.ExitYPos = 7;
            ...
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Guard, 3, 0, "Guard_01"));
            Game.BoardEnemies["Guard_01"].Set(health: 2, speed: 0.8, delay: 500, direction: "down", startDelay: 0);

            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 1, 3, 6, 3, BoardBuilder.FillType.SolidBox);

            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 4, 0, 7, 0, BoardBuilder.FillType.SolidBox);
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 4, 2, 6, 2, BoardBuilder.FillType.SolidBox);

            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 0, 3, "1"));
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 1, 4, 1, 6, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 0, 5));
            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 0, 4));

            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 5, 1));
            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 6, 1, "2"));

            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 6, 5));
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 3, 6, 7, 6, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Guard, 7, 5, "Guard_02"));
            Game.BoardEnemies["Guard_02"].Set(health: 2, speed: 0.8, delay: 500, direction: "up", startDelay: 0);

            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Guard, 5, 4, "Guard_03"));
            Game.BoardEnemies["Guard_03"].Set(health: 2, speed: 0.8, delay: 500, direction: "down", startDelay: 0);

            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Guard, 3, 5, "Guard_04"));
            Game.BoardEnemies["Guard_04"].Set(health: 2, speed: 0.8, delay: 500, direction: "up", startDelay: 0);

            GameLevel.AddObject(new GameObject(GameController.Objects.Key, 0, 6, "a"));
            GameLevel.AddObject(new GameObject(GameController.Objects.KeyDoor, 3, 7, "a"));
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text("X", fgColor: ConsoleColor.Red));
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "\" são Os Guardas." : "\" are The Guards."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? " Eles se movem de um lado para o outro. Tome cuidado!" : " They move side to side. Be careful!", centerLine: true));
