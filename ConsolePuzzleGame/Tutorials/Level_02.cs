...
namespace ConsolePuzzleGame.Tutorials
{
    ...
    {
        public int BoardWidth = 5, BoardHeight = 3;
        ...
        void Start()
        {
            ...
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 3, 0));
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "Você não pode atravessar paredes \"" : "You can not pass through the walls \"", centerLine: true));
            Header.Line[2].Add(new Text("   ",ConsoleColor.DarkGray));
            Header.Line[2].Add(new Text("\"."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? "Elas são fixas e indestrutíveis." : "They are fixed and undestructible.", centerLine: true));
