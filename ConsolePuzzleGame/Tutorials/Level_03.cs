...
namespace ConsolePuzzleGame.Tutorials
{
    ...
    {
        public int BoardWidth = 8, BoardHeight = 5;
        ...
        void Start()
        {
            ...
            GameLevel.PlayerXPos = 0; GameLevel.PlayerYPos = GameLevel.BoardHeight-1;
            ...
            GameLevel.ExitXPos = GameLevel.BoardWidth-1; GameLevel.ExitYPos = 4;
            ...
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 5, 0, 7, 1, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 5, 2, "2"));
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 5, 3, 6, 4, BoardBuilder.FillType.SolidBox);

            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 1, 4));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 1, 3));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 2, 3));

            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 4, 1));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 3, 1));

            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 4, 0));
            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 2, 4));
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text("[",ConsoleColor.Black,ConsoleColor.DarkYellow));
            Header.Line[2].Add(new Text(Game.BoardObjects[2][5].Content,ConsoleColor.Black,ConsoleColor.Yellow));
            Header.Line[2].Add(new Text("]",ConsoleColor.Black,ConsoleColor.DarkYellow));
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "\" é uma porta que só abre ao coletar um certo número de moedas \"" : "\" is a door that only opens after collecting some coins \""));
            Header.Line[2].Add(new Text("$",ConsoleColor.Black,ConsoleColor.Yellow));
            Header.Line[2].Add(new Text("\"."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? "Tente sempre coleta-las." : "Try always to collect them.", centerLine: true));
