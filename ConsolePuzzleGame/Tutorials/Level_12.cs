...
namespace ConsolePuzzleGame.Tutorials
{
    public class Tutorial_12 : Level
    {
        ...
        void Start()
        {
            ...
            GameLevel.P1_XField = 3; GameLevel.P1_YField = 3;
            ...
            GameLevel.ExitXPos = 11; GameLevel.ExitYPos = 11;
            ...
            GameLevel.Board.Fill(GameController.Objects.CoinDoor, Game.BoardObjects, 0, 0, 12, 12, BoardBuilder.FillType.DrawnGrid,"7",
                "*w*******w*w" +
                "*w*wwwww*w**" +
                "***w***wwww*" +
                "*w***w******" +
            ...
            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 10, 10, "1"));
            ...
            if (GameLevel.LevelCompleted)
            {
                ...
                Thread.Sleep(400);
                Console.Clear();
                Console.WriteLine("Isso é tudo por enquanto... Rs");
                Console.WriteLine("              -By Pedro Barros");
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "Às você não consegue ver tudo ao seu redor." : "Sometimes you can't see everything arround you.", centerLine: true));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? "Cuidado!" : "Caution!", centerLine: true));
