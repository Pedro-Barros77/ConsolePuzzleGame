...
namespace ConsolePuzzleGame.Tutorials
{
    ...
    {
        public int BoardWidth = 7, BoardHeight = 7;
        ...
        void Start()
        {
            ...
            GameLevel.ExitXPos = 6; GameLevel.ExitYPos = 6;
            ...
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 0, 1, 5, 1, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 5, 0));

            GameLevel.AddObject(new GameObject(GameController.Objects.Portal, 4, 0, "a"));
            GameLevel.AddObject(new GameObject(GameController.Objects.Portal, 0, 6, "A"));

            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 1, 2, 1, 6, BoardBuilder.FillType.SolidBox);

            GameLevel.AddObject(new GameObject(GameController.Objects.Portal, 0, 2, "b"));
            GameLevel.AddObject(new GameObject(GameController.Objects.Portal, 6, 0, "B"));

            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 5, 5, 5, 6, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 6, 5, "2"));

            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 3, 3));
            GameLevel.AddObject(new GameObject(GameController.Objects.Coin, 3, 5));
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text("|", fgColor: ConsoleColor.DarkBlue));
            Header.Line[2].Add(new Text("a", fgColor: ConsoleColor.Blue));
            Header.Line[2].Add(new Text("|", fgColor: ConsoleColor.DarkBlue));
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "\" são Portais." : "\" are Portals."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? "Eles te teleportam para outro portal com a mesma letra." : "They teleport you to another portal with the same letter.", centerLine: true));
