...
namespace ConsolePuzzleGame.Tutorials
{
    ...
    {
        public int BoardWidth = 10, BoardHeight = 12;
        ...
        void Start()
        {
            ...
            GameLevel.PlayerXPos = 0; GameLevel.PlayerYPos = 1;
            ...
            GameLevel.ExitXPos = 0; GameLevel.ExitYPos = 11;
            ...
            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 1, 2, 9, 2, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.KeyDoor, 0, 2, "a"));
            GameLevel.AddObject(new GameObject(GameController.Objects.Key, 9, 1, "a"));

            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 1, 1));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 3, 1));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 5, 1));
            GameLevel.AddObject(new GameObject(GameController.Objects.Wall, 7, 1));



            GameLevel.Board.Fill(GameController.Objects.Wall, Game.BoardObjects, 0, 5, 0, 10, BoardBuilder.FillType.SolidBox);

            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 9, 0, "Cannon_01"));
            Game.BoardEnemies["Cannon_01"].Set(health: 2, direction: "left", bulletSpeed: 4, rateOfFire: 0.5, startDelay: 0);

            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 1, 10, "Cannon_02"));
            Game.BoardEnemies["Cannon_02"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 2, 10, "Cannon_03"));
            Game.BoardEnemies["Cannon_03"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 3, 10, "Cannon_04"));
            Game.BoardEnemies["Cannon_04"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 4, 10, "Cannon_05"));
            Game.BoardEnemies["Cannon_05"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 5, 10, "Cannon_06"));
            Game.BoardEnemies["Cannon_06"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 6, 10, "Cannon_07"));
            Game.BoardEnemies["Cannon_07"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 7, 10, "Cannon_08"));
            Game.BoardEnemies["Cannon_08"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);
            GameLevel.AddObject(new GameObject(GameController.Objects.Enemy_Cannon, 8, 10, "Cannon_09"));
            Game.BoardEnemies["Cannon_09"].Set(health: 2, direction: "up", bulletSpeed: 4, rateOfFire: 0.85, startDelay: 0);

            GameLevel.Board.Fill(GameController.Objects.Coin, Game.BoardObjects, 1, 5, 8, 5, BoardBuilder.FillType.SolidBox);
            GameLevel.AddObject(new GameObject(GameController.Objects.CoinDoor, 8, 11, "5"));
        ...
        public void AddContent()
        {
            ...
            Header.Line[2].Add(new Text("=(]", fgColor: ConsoleColor.Red));
            Header.Line[2].Add(new Text(", "));
            Header.Line[2].Add(new Text("/'\\", fgColor: ConsoleColor.Red));
            Header.Line[2].Add(new Text(MenuController.Language == 1 ? "\" são Os Canhões." : "\" are The Cannons."));
            Header.Line[3].Add(new Text(MenuController.Language == 1 ? " É melhor pegar cobertura!" : " You better get cover!", centerLine: true));
